...
export default class DeviceOrientation extends EventEmitter
{
    ...
    handleMotionEvent(event) {
        ...
        this.experience.camera.instance.rotation.x = event.alpha * 1
        this.experience.camera.instance.rotation.y = event.beta * 1
        this.experience.camera.instance.rotation.z = event.gamma * 1
